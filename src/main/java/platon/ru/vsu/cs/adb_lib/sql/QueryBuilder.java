...
public class QueryBuilder {
    ...
    public QueryBuilder(String[] columnNames, String tablename, String pkColumnName) {
    ...
    public String insert(Integer id, String[] columnValues){
        ...
        if(id != null) {
            queryString.append(pkColumnName);
            queryString.append(", ");
        }
    ...
    public String delete(int id){
        return "DELETE FROM " + tablename + " where " + pkColumnName + " = " + id;
    }
    ...
    public String update(String[] newerColumnValues, int id){
        ...
        queryString.append(" where ").append(pkColumnName).append(" = ").append(id);
